...
function ScholarRegistration() {
  ...
  async function signUp() {
    ...
    try {
      let result = await fetch("http://localhost:8000/api/scholarregistration", {
        method: "POST",
        headers: {
  ...
  // if Learner is login redirect to Home Page
  useEffect(() => {
            ...
            <div class="form-content register-content" style={{ backgroundColor: "white" }}>
              <div class="col-sm-12">
                ...
                <label style={{float:"left"}}>First Name*</label>
                  ...
                  <a href="/ScholarLogin"><em>Already have an Account! Login Now!!!</em></a> <br></br>
                  <br></br>
